...
--
-- Name: worldcup; Type: DATABASE; Schema: -; Owner: jvsouzx
--

CREATE DATABASE worldcup WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'C.UTF-8' LC_CTYPE = 'C.UTF-8';


ALTER DATABASE worldcup OWNER TO jvsouzx;
...
--
-- Name: games; Type: TABLE; Schema: public; Owner: jvsouzx
--
...
ALTER TABLE public.games OWNER TO jvsouzx;

--
-- Name: games_game_id_seq; Type: SEQUENCE; Schema: public; Owner: jvsouzx
--
...
ALTER TABLE public.games_game_id_seq OWNER TO jvsouzx;

--
-- Name: games_game_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jvsouzx
--
...
--
-- Name: teams; Type: TABLE; Schema: public; Owner: jvsouzx
--
...
ALTER TABLE public.teams OWNER TO jvsouzx;

--
-- Name: teams_team_id_seq; Type: SEQUENCE; Schema: public; Owner: jvsouzx
--
...
ALTER TABLE public.teams_team_id_seq OWNER TO jvsouzx;

--
-- Name: teams_team_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: jvsouzx
--
...
--
-- Name: games game_id; Type: DEFAULT; Schema: public; Owner: jvsouzx
--
...
--
-- Name: teams team_id; Type: DEFAULT; Schema: public; Owner: jvsouzx
--
...
--
-- Data for Name: games; Type: TABLE DATA; Schema: public; Owner: jvsouzx
--
...
--
-- Data for Name: teams; Type: TABLE DATA; Schema: public; Owner: jvsouzx
--
...
--
-- Name: games_game_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jvsouzx
--
...
--
-- Name: teams_team_id_seq; Type: SEQUENCE SET; Schema: public; Owner: jvsouzx
--
...
--
-- Name: games games_pkey; Type: CONSTRAINT; Schema: public; Owner: jvsouzx
--
...
--
-- Name: teams teams_name_key; Type: CONSTRAINT; Schema: public; Owner: jvsouzx
--
...
--
-- Name: teams teams_pkey; Type: CONSTRAINT; Schema: public; Owner: jvsouzx
--
...
--
-- Name: games games_opponent_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jvsouzx
--
...
--
-- Name: games games_winner_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jvsouzx
--
